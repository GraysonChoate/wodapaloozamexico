...
`git diff 26a891a -- build/` was empty at capture time, so these depict exactly the pushed
rendering code.
...
| 18 | b6 · 1.00 | the steps | the descent lands; altimeter reads FLOOR (unit dropped) |
| 19 | b7 · 0.06 | the placement begins | the figure at a pole on Reforma, Ángel behind — **cyan badge, same hoodie as Beat 5** |
| 20 | b7 · 0.24 | pressing the badge on | the act itself; this is the 21% of runtime given 34% of the scroll |
| 21 | b7 · 0.44 | surface — deep blue | montage begins; frame locked off, only the surface changes |
| 22 | b7 · 0.66 | surface — Talavera azulejo | source-native blue; nothing applied |
| 23 | b7 · 0.84 | surface — red wall | source-native red |
| 24 | b7 · 0.99 | occupied | metadata line: REFORMA · ONE MARK · SEVENTY-FOUR CUTS · NO GRADE |
